...
一个基于Java、Spring AI的轻量级智能体开发平台，提供完整的AI智能体管理和工作流执行能力。
...
- **领域层**: 包含核心业务逻辑和领域模型
- **应用层**: 协调领域对象完成业务流程
- **基础设施层**: 实现领域层定义的接口，包含数据访问、外部系统集成等
- **触发器层**: 处理定时任务、Http接口等功能
...
如有任何问题，请随时联系项目维护者：
- 作者邮箱: szhuima@gmail.com
- GitHub Issues: 欢迎在项目仓库中提交Issue

---

> 感谢您对My-Agent项目的关注和支持！我们期待与您一起构建更加强大的智能体开发平台。
