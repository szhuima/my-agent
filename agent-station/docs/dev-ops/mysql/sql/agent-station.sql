...
CREATE database if NOT EXISTS `agent-station` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `agent-station`;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='AI智能体配置表';

LOCK TABLES `ai_agent` WRITE;
/*!40000 ALTER TABLE `ai_agent`
    DISABLE KEYS */;

INSERT INTO `ai_agent` (`id`, `agent_name`, `description`, `channel`, `status`, `create_time`, `update_time`)
VALUES (1, '自动发帖服务01', 'CSDN自动发帖，微信公众号通知。', 'agent', 1, '2025-05-04 19:48:05', '2025-05-07 09:20:40'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='智能体-客户端关联表';

LOCK TABLES `ai_agent_client` WRITE;
/*!40000 ALTER TABLE `ai_agent_client`
    DISABLE KEYS */;

INSERT INTO `ai_agent_client` (`id`, `agent_id`, `client_id`, `sequence`, `create_time`)
VALUES (1, 1, 1, 1, '2025-05-04 07:34:46'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='智能体任务调度配置表';

LOCK TABLES `ai_agent_task_schedule` WRITE;
/*!40000 ALTER TABLE `ai_agent_task_schedule`
    DISABLE KEYS */;

INSERT INTO `ai_agent_task_schedule` (`id`, `agent_id`, `task_name`, `description`, `cron_expression`, `task_param`,
                                      `status`, `create_time`, `update_time`)
VALUES (1, 1, '自动发帖', '自动发帖和通知', '0 0/30 * * * ?', '发布CSDN文章', 1, '2025-05-05 15:58:58',
        '2025-05-07 12:09:33');
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='AI客户端配置表';

LOCK TABLES `ai_client` WRITE;
/*!40000 ALTER TABLE `ai_client`
    DISABLE KEYS */;

INSERT INTO `ai_client` (`id`, `client_name`, `description`, `status`, `create_time`, `update_time`)
VALUES (1, '提示词优化', '提示词优化，分为角色、动作、规则、目标等。', 1, '2025-05-04 19:47:56', '2025-05-05 10:02:55'),
       (2, '自动发帖和通知', '自动生成CSDN文章，发送微信公众号消息通知', 1, '2025-05-05 10:05:43',
        '2025-05-05 10:09:20'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='顾问配置表';

LOCK TABLES `ai_client_advisor` WRITE;
/*!40000 ALTER TABLE `ai_client_advisor`
    DISABLE KEYS */;

INSERT INTO `ai_client_advisor` (`id`, `advisor_name`, `advisor_type`, `order_num`, `ext_param`, `status`,
                                 `create_time`, `update_time`)
VALUES (1, '记忆', 'ChatMemory', 1, '{\n    \"maxMessages\": 200\n}', 1, '2025-05-04 08:23:25', '2025-05-05 09:01:58'),
       (5, '知识库', 'RagAnswer', 1,
        '{\n    \"topK\": \"4\",\n    \"filterExpression\": \"knowledge == \'知识库名称\'\"\n}', 1,
        '2025-05-04 08:23:25', '2025-05-04 08:58:31');
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='客户端-顾问关联表';

LOCK TABLES `ai_client_advisor_config` WRITE;
/*!40000 ALTER TABLE `ai_client_advisor_config`
    DISABLE KEYS */;

INSERT INTO `ai_client_advisor_config` (`id`, `client_id`, `advisor_id`, `create_time`)
VALUES (1, 1, 1, '2025-05-04 08:36:38'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='AI接口模型配置表';

LOCK TABLES `ai_client_model` WRITE;
/*!40000 ALTER TABLE `ai_client_model`
    DISABLE KEYS */;

INSERT INTO `ai_client_model` (`id`, `model_name`, `base_url`, `api_key`, `completions_path`, `embeddings_path`,
                               `model_type`, `model_version`, `timeout`, `status`, `create_time`, `update_time`)
VALUES (1, '智能体对话', 'https://apis.itedus.cn', 'sk-gU8CZ5ZjMhqoq7922fD7488857F44d38A***可以找小傅哥申请',
        'v1/chat/completions', 'v1/embeddings', 'openai', 'gpt-4.1-mini', 30, 1, '2025-05-02 07:30:51',
        '2025-05-07 09:22:46'),
       (2, '流式对话', 'https://apis.itedus.cn', 'sk-gU8CZ5ZjMhqoq7922fD7488857F44d38A***可以找小傅哥申请',
        'v1/chat/completions', 'v1/embeddings', 'openai', 'gpt-4.1-mini', 30, 1, '2025-05-02 07:30:51',
        '2025-05-07 09:21:59');
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='AI客户端，零部件；模型配置';

LOCK TABLES `ai_client_model_config` WRITE;
/*!40000 ALTER TABLE `ai_client_model_config`
    DISABLE KEYS */;

INSERT INTO `ai_client_model_config` (`id`, `client_id`, `model_id`, `create_time`)
VALUES (1, 1, 1, '2025-05-02 17:23:22'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='AI客户端，零部件；模型工具配置';

LOCK TABLES `ai_client_model_tool_config` WRITE;
/*!40000 ALTER TABLE `ai_client_model_tool_config`
    DISABLE KEYS */;

INSERT INTO `ai_client_model_tool_config` (`id`, `model_id`, `tool_type`, `tool_id`, `create_time`)
VALUES (1, 2, 'mcp', 1, '2025-05-02 17:23:22'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='系统提示词配置表';

LOCK TABLES `ai_client_system_prompt` WRITE;
/*!40000 ALTER TABLE `ai_client_system_prompt`
    DISABLE KEYS */;

INSERT INTO `ai_client_system_prompt` (`id`, `prompt_name`, `prompt_content`, `description`, `status`, `create_time`,
                                       `update_time`)
VALUES (1, '提示词优化',
        '你是一个专业的AI提示词优化专家。请帮我优化以下prompt，并按照以下格式返回：\n\n# Role: [角色名称]\n\n## Profile\n\n- language: [语言]\n- description: [详细的角色描述]\n- background: [角色背景]\n- personality: [性格特征]\n- expertise: [专业领域]\n- target_audience: [目标用户群]\n\n## Skills\n\n1. [核心技能类别]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n2. [辅助技能类别]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n   - [具体技能]: [简要说明]\n\n## Rules\n\n1. [基本原则]：\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n2. [行为准则]：\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n   - [具体规则]: [详细说明]\n3. [限制条件]：\n   - [具体限制]: [详细说明]\n   - [具体限制]: [详细说明]\n   - [具体限制]: [详细说明]\n   - [具体限制]: [详细说明]\n\n## Workflows\n\n- 目标: [明确目标]\n- 步骤 1: [详细说明]\n- 步骤 2: [详细说明]\n- 步骤 3: [详细说明]\n- 预期结果: [说明]\n\n## Initialization\n\n作为[角色名称]，你必须遵守上述Rules，按照Workflows执行任务。\n请基于以上模板，优化并扩展以下prompt，确保内容专业、完整且结构清晰，注意不要携带任何引导词或解释，不要使用代码块包围。',
        '提示词优化，拆分执行动作', 1, '2025-05-04 21:14:24', '2025-05-05 10:04:25'),
       (3, '发帖和消息通知介绍',
        ...
        '提示词优化，拆分执行动作', 1, '2025-05-04 21:14:24', '2025-05-05 10:10:42'),
       (4, 'CSDN发布文章',
        ...
        'CSDN发布文章', 1, '2025-05-07 12:05:36', '2025-05-07 12:05:36'),
       (5, '文章操作测试', '在 /Users/fuzhengwei/Desktop 创建文件 file01.txt', '文件操作测试', 1, '2025-05-07 12:06:03',
        '2025-05-07 12:06:08');
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='客户端-MCP关联表';

LOCK TABLES `ai_client_tool_config` WRITE;
/*!40000 ALTER TABLE `ai_client_tool_config`
    DISABLE KEYS */;

INSERT INTO `ai_client_tool_config` (`id`, `client_id`, `tool_type`, `tool_id`, `create_time`)
VALUES (1, 2, 'mcp', 1, '2025-05-04 07:31:54'),
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='MCP客户端配置表';

LOCK TABLES `ai_client_tool_mcp` WRITE;
/*!40000 ALTER TABLE `ai_client_tool_mcp`
    DISABLE KEYS */;

INSERT INTO `ai_client_tool_mcp` (`id`, `mcp_name`, `transport_type`, `transport_config`, `request_timeout`, `status`,
                                  `create_time`, `update_time`)
VALUES (1, 'CSDN自动发帖', 'sse', '{\n	\"baseUri\":\"http://mcp-server-csdn-app:8101\"\n}', 180, 1,
        '2025-05-02 18:43:28', '2025-05-05 12:07:52'),
       (2, '微信公众号消息通知', 'sse', '{\n	\"baseUri\":\"http://mcp-server-weixin-app:8102\"\n}', 180, 1,
        '2025-05-02 18:43:28', '2025-05-05 12:07:57'),
       (3, 'filesystem', 'stdio',
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='知识库配置表';
